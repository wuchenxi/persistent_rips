# -*- coding: utf-8 -*-
"""
Created on Wed Aug 22 19:24:05 2018
...
def cut_spec(X, pctg=0.1, **kwargs):
    """
    ...
    style = kwargs['style']
    W = kwargs['W']
    threshold = np.percentile(W,pctg*100)
    original_connection = (W < threshold)
    W = np.multiply(W,original_connection)
